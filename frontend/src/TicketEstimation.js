...
import { PlanEditor, planText, pmPlanComment } from './TicketEstimatePanel';
...
// PlanEditor is now the shared component in ./TicketEstimatePanel (imported above) so the QC-queue
// popup and this module render the identical plan editor.

const round1 = (n) => Math.round((Number(n) || 0) * 10) / 10;
// planText is now the shared helper in ./TicketEstimatePanel (imported above).
...
// pmPlanComment is now the shared helper in ./TicketEstimatePanel (imported above).
